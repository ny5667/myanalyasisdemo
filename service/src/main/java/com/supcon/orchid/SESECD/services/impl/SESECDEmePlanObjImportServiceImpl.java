...
@Service("sESECDEmePlanObjImportService")
public class SESECDEmePlanObjImportServiceImpl implements SESECDEmePlanObjImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_EmePlanObj",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmePlanObj bizObj, SESECDEmePlanObj oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmePlanObj bizObj, String bussinesskeyFieldName,
