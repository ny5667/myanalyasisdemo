...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_emcAction_MainPeople,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDMainPeopleDaoImpl extends ExtendedGenericDaoImpl<SESECDMainPeople, Long> implements SESECDMainPeopleDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_emcAction_MainPeople,SESECD_1.0.0) */
// 自定义代码
