...
/* CUSTOM CODE START(controller,import,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码
...
@Api
public class SESECDAlarmEnenetrelController extends BaseController<SESECDAlarmEnenetrel> {
	...
	//=================以下是controller请求的方法========================
    	 ...
    	 * @throws Exception
    	 */
    	@PostMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/proj/{viewName}-query", produces = "application/json")
    	@ResponseBody
    	public String projListQuery(@RequestBody(required = false) QueryEntity queryEntity, HttpServletRequest request, HttpServletResponse response) throws Exception {
    		Page<SESECDAlarmEnenetrel> page = new Page<SESECDAlarmEnenetrel>();
    		...
    		alarmEnenetrelService.listQuery(page, currentSqlType, viewCode, datagridCode, null, queryEntity.getProcessKey(),
    		...
    		if(queryEntity.isExportFlag()){
    			...
    			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode("SESECD_1.0.0_alarmRecord_AlarmEnenetrel.xls", "UTF-8"));
    			Model model = modelServiceFoundation.getModel("SESECD_1.0.0_alarmRecord_AlarmEnenetrel");
    			exportService.exportExcel(out,response,model, page, viewCode);
    			alarmEnenetrelService.excelExport();
    			return null;
    		}
    		return JSONPlainSerializer.serializeAsJSON(page, includes, new BAPEntityTransformer());
    	}
	private void getFullObject(Page<SESECDAlarmEnenetrel> page){
		List<SESECDAlarmEnenetrel> alarmEnenetrels = page.getResult();
		List<Long> ids = alarmEnenetrels.stream().map(SESECDAlarmEnenetrel::getId).collect(Collectors.toList());
        page.setResult(alarmEnenetrelService.findSESECDAlarmEnenetrelByIds(ids));
	}
	 ...
	 *  参照视图公用数据查询方法
	*/
@PostMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/projref/{viewName}-query", produces = "application/json")
    	@ResponseBody
    	public String projRefListQuery(@RequestBody(required = false) QueryEntity queryEntity, HttpServletRequest request, HttpServletResponse response) throws Exception {
    		...
    		// 实体未启用工作流
    		alarmEnenetrelService.listQuery(page, currentSqlType, viewCode, null, queryEntity.getCrossCompanyFlag(), null,
	...
	@GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/selectData", produces = "application/json")
	@ResponseBody
	public String selectData(String includes) throws Exception {
		Page<SESECDAlarmEnenetrel> page = new Page<SESECDAlarmEnenetrel>();
		page.setPageSize(page.getMaxPageSize());
		List<SESECDAlarmEnenetrel> result = alarmEnenetrelService.findAlarmEnenetrelsByHql("from " + SESECDAlarmEnenetrel.JPA_NAME + " where valid =1");
...
/**
	...
	*/
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = {"/SESECD/alarmRecord/alarmEnenetrel/data/{id}",
		"/SESECD/alarmRecord/alarmEnenetrel/proj/data/{id}"}, produces = "application/json")
	@ResponseBody
	public Object getData(@PathVariable long id, Long pendingId, String includes, HttpServletRequest request) throws Exception {
		SESECDAlarmEnenetrel result = alarmEnenetrelService.getAlarmEnenetrel(id,pendingService.getViewCodeByPending(pendingId));
		// 返回图片类型字段信息
...
/**
    	 ...
    	 */
    	@PostMapping(value = {
    		"/SESECD/alarmRecord/alarmEnenetrel/proj/{viewName}/save",
    		"/SESECD/alarmRecord/alarmEnenetrel/proj/{viewName}/submit"
    		}, produces = "application/json")
    	@ResponseBody
    	public Object projsubmit(Long id, HttpServletRequest request) throws Exception {
    		SESECDAlarmEnenetrelEditEntity editEntity;
    		ObjectMapper objectMapper = new ObjectMapper();
    		objectMapper.configure(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY, true);
    		objectMapper.configure(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT, true) ;
    		objectMapper.enable(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT);
    		objectMapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
    		bapBeforeCustomMethod("SESECD_1.0.0_alarmRecord_AlarmEnenetrel", "submit", null);
    		if (null != id) {
    			SESECDAlarmEnenetrel ordinaryAlarmEnenetrel = alarmEnenetrelService.getAlarmEnenetrelWithoutMultiselect(id);
    			// 前端传的json
    			...
    			Map<String,Object> alarmEnenetrelMap = (Map<String, Object>) editEntityMap.get("alarmEnenetrel");
    			editEntity = objectMapper.readValue(body, SESECDAlarmEnenetrelEditEntity.class);
    			SESECDAlarmEnenetrel alarmEnenetrel = editEntity.getAlarmEnenetrel();
    			// 只更新前端传的，其他按数据库里原有的数据
    			for (Field field : ReflectUtils.getDeepDeclaredFields(SESECDAlarmEnenetrel.class)) {
    				// 前端没传，继续遍历下一个字段
    				if (null == alarmEnenetrelMap.get(field.getName())) {
    					continue;
    				}
    				field.setAccessible(true);
    				// 实际更新
    				field.set(ordinaryAlarmEnenetrel, field.get(alarmEnenetrel));
    			}
    			editEntity.setAlarmEnenetrel(ordinaryAlarmEnenetrel);
    		} else {
    			editEntity = objectMapper.readValue(request.getAttribute("body").toString(), SESECDAlarmEnenetrelEditEntity.class);
    		}
    		SESECDAlarmEnenetrel alarmEnenetrel = editEntity.getAlarmEnenetrel();
            ...
            try {
                responseMap = alarmEnenetrelService.submit(alarmEnenetrel, editEntity.getWorkFlowVar(),
                ...
                // 如果模型需要审计
                boolean modelNeedAudit = ModelAuditLogCache.isAuditLogEnabled("SESECD_1.0.0_alarmRecord_AlarmEnenetrel", AuditLogType.BUSINESS);
                if (modelNeedAudit) {
                    ...
                    auditBusinessLogBO.setMainModelCode("SESECD_1.0.0_alarmRecord_AlarmEnenetrel");
                    auditBusinessLogBO.setMainModelName("SESECD.alarmRecord.AlarmEnenetrel");
            ...
            afterSubmitAtNewTransactionCustomMethod(editEntity.getViewCode(), "submit", alarmEnenetrel);
    		...
    		fileuploads.put("linkId", alarmEnenetrel.getId());
    		request.setAttribute("__orchid_fileuploads__", fileuploads);
    		bapAfterCustomMethod("SESECD_1.0.0_alarmRecord_AlarmEnenetrel", "submit", null);
    		return responseMap;
    	}
	 ...
	 * 判断进入submit接口的操作类型
	 */
	private OperateType getSubmitOperateType(Long id, SESECDAlarmEnenetrelEditEntity editEntity) {
        // 超级编辑
	 ...
	 * @return
	 */
	@GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/proj/{viewName}")
	public String projView(@RequestParam(value = "clientType",required = false) String clientType,@PathVariable String viewName,HttpServletRequest request) throws Exception {
		...
		alarmEnenetrelService.generateHtmlFile(request.getRequestURI(), projViewRelevantPath);
		return projViewRelevantPath;
	}
	...
	/**
	 * 打开页面eventEditMobile
	 * url:/SESECD/alarmRecord/alarmEnenetrel/eventEditMobile
	 * @return
	 */
	@GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/eventEditMobile")
	...
	@GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/editStates", produces = "application/json")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@PostMapping("/SESECD/alarmRecord/alarmEnenetrel/delete")
	@ResponseBody
	@AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
                      operateType = OperateType.DELETE,
                      modelCodes = {"SESECD_1.0.0_alarmRecord_AlarmEnenetrel"},
                      mainModelCode = "SESECD_1.0.0_alarmRecord_AlarmEnenetrel",
                      mainModelName = "SESECD.alarmRecord.AlarmEnenetrel",
	...
	public Map<String, Object> delete(String ids, HttpServletRequest request) throws Exception {
		...
		alarmEnenetrelService.deleteAlarmEnenetrel(ids, signatureLog);
		Map<String, Object> responseMap = new HashMap<>();
	 ...
	 */
	@PostMapping(value = {
	    "/SESECD/alarmRecord/alarmEnenetrel/data-{dg.name}",
		"/SESECD/alarmRecord/alarmEnenetrel/proj/data-{dg.name}"
	...
	public String dataGridData(Long id, Long refId, String datagridCode, @RequestBody(required = false)QueryEntity queryEntity,
			...
			DataGrid dg = viewServiceFoundation.getDataGrid(datagridCode);
            		if(dg !=null && dg.getDataGridType()==1){
                        ...
                        alarmEnenetrelService.dataGridData(dgPage, datagridCode, dataGridName, request.getParameterMap(), refId,id,queryEntity);
	...
	@GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/echartsData", produces = "application/json")
	@ResponseBody
	...
	@GetMapping(value = {"/SESECD/alarmRecord/alarmEnenetrel/importMainXls","/SESECD/alarmRecord/alarmEnenetrel/proj/importMainXls"}, produces = "application/json")
	@ResponseBody
	public Object importMainXls(String filePath, String viewCode, boolean isReplace, boolean isIgnore, HttpServletRequest request) {
		Object[] importServices = new Object[]{"com.supcon.orchid.SESECD.services.SESECDAlarmEnenetrelService"
			...
			if(dataFile != null){
                ...
                if (getSTATE() == 0) {
					synchronized (this) {
						changeState(0);
						try {
				            xlsResult = importService.batchImports(viewCode, "SESECD_1.0.0_alarmRecord_AlarmEnenetrel", dataFile, time, name, isReplace, isIgnore, true, "xls", signatureLog, newService);
                        } finally {
                            changeState(1);
                        }
                    }
    ...
    @GetMapping(value = {"/SESECD/alarmRecord/alarmEnenetrel/importXls","/SESECD/alarmRecord/alarmEnenetrel/proj/importXls"}, produces = "application/json")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = {"/SESECD/alarmRecord/alarmEnenetrel/downloadXls","/SESECD/alarmRecord/alarmEnenetrel/proj/downloadXls"})
	@ResponseBody
    ...
    @GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/networkPrint", produces = "application/json")
	@ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
	...
	public String print(String printerName,String templateCode,Long id,Integer count,String modelCode,HttpServletRequest request){
		SESECDAlarmEnenetrel alarmEnenetrel=alarmEnenetrelService.getAlarmEnenetrel(id);
		...
		if (isSuccess) {
			...
			try {
				result = printClientService.doPrintInfo(alarmEnenetrel,templateCode, Long.valueOf(id), modelCode, printerName, Integer.valueOf(count),paramMap);
				if (!"SUCCESS".equals(result)) {
					isSuccess = false;
				}
			} catch (Exception e) {
    ...
    @GetMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/printOnServer", produces = "application/json")
    @ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
                      operateType = OperateType.PRINT,
    ...
    public Map<String, Object> printOnServer(Long id, String templateCode, String viewCode, HttpServletRequest request) throws Exception {
    	SESECDAlarmEnenetrel alarmEnenetrel = null;
    	if(null != id) {
    		alarmEnenetrel = alarmEnenetrelService.getAlarmEnenetrel(id);
    	}
    //		String templateCode = request.getParameter("templateCode");
    	SignatureLog signatureLog = (SignatureLog)request.getAttribute("signatureLog");
    	String pdfFileName=printService.printOnServer(alarmEnenetrel,templateCode,viewCode, null,signatureLog);
    	printXmlInfo.put("pdfFileName", pdfFileName);
    	return printXmlInfo;
    }
    @PostMapping(value = "/SESECD/alarmRecord/alarmEnenetrel/batchPrintOnServer", produces = "application/json")
    @ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
    ...
    public Map<String, Object> batchPrintOnServer(@RequestParam(value = "ids") String ids,
        ...
        if (ids != null && ids.length() > 0) {
            ...
            for (int i = 0; i < arrId.length; i++) {
                objs.add(alarmEnenetrelService.getAlarmEnenetrel(Long.parseLong(arrId[i])));
            }
        }
    ...
    */
    ...
    /* CUSTOM CODE START(controller,beforeReturnHtmlMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(controller,beforeMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(controller,afterMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
	}

	private void bapGetDataAfterCustomMethod(String methodName, SESECDAlarmEnenetrel result, String includes) throws Exception {
    /* CUSTOM CODE START(controller,getDataAfterMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
    private void bapBeforeRecallMethod(Long tableinfoId) throws Exception {
	/* CUSTOM CODE START(controller,beforeRecallMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void bapAfterRecallMethod(Long tableinfoId) throws Exception {
    /* CUSTOM CODE START(controller,afterRecallMethods,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
    private void afterSubmitAtNewTransactionCustomMethod(String viewCode, String methodName, SESECDAlarmEnenetrel result) throws Exception {
    /* CUSTOM CODE START(controller,afterSubmitAtNewTransaction,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
	/* CUSTOM CODE START(controller,functions,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码
