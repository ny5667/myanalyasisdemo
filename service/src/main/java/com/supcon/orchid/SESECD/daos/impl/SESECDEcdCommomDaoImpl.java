...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_ecdPanel_EcdCommom,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEcdCommomDaoImpl extends ExtendedGenericDaoImpl<SESECDEcdCommom, Long> implements SESECDEcdCommomDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_ecdPanel_EcdCommom,SESECD_1.0.0) */
// 自定义代码
