...
@Service("sESECDCommunicationImportService")
public class SESECDCommunicationImportServiceImpl implements SESECDCommunicationImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_Communication",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDCommunication bizObj, SESECDCommunication oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDCommunication bizObj, String bussinesskeyFieldName,
