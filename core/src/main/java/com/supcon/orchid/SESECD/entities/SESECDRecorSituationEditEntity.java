...
public class SESECDRecorSituationEditEntity implements Serializable {
	...
	private SESECDRecorSituation recorSituation;

	public SESECDRecorSituation getRecorSituation(){
		return recorSituation;
	}

	public void setRecorSituation(SESECDRecorSituation recorSituation){
		this.recorSituation = recorSituation;
	}
}