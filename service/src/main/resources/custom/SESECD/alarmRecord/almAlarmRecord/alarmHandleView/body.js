      ...
      function(res) {
        ...
        for(var i=0; i< res.result.length; i++){
            ReactAPI.getComponentAPI("SupDataGrid")
                .APIs("SESECD_1.0.0_alarmRecord_alarmHandleViewdg1600177870401")
                .setFormatHtml(i, "sort", '<a href="javascript:void(0)" onclick="openVideoWindow(\'' + res.result[i].hls + '\')"><span style="color:blue;">' + ReactAPI.international.getText("SESECD.custom.randon1600973304988") + '</span></a>');
        }
