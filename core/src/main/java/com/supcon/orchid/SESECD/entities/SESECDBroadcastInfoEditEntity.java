...
public class SESECDBroadcastInfoEditEntity implements Serializable {
	...
	private SESECDBroadcastInfo broadcastInfo;

	public SESECDBroadcastInfo getBroadcastInfo(){
		return broadcastInfo;
	}

	public void setBroadcastInfo(SESECDBroadcastInfo broadcastInfo){
