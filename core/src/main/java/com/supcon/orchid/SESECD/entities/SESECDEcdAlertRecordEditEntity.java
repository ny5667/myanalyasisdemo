...
public class SESECDEcdAlertRecordEditEntity implements Serializable {
	...
	private SESECDEcdAlertRecord ecdAlertRecord;

	public SESECDEcdAlertRecord getEcdAlertRecord(){
		return ecdAlertRecord;
	}

	public void setEcdAlertRecord(SESECDEcdAlertRecord ecdAlertRecord){
		this.ecdAlertRecord = ecdAlertRecord;
	}
}