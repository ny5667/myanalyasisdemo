...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_signalConfig_SourceTerminal,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDSourceTerminalDaoImpl extends ExtendedGenericDaoImpl<SESECDSourceTerminal, Long> implements SESECDSourceTerminalDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_signalConfig_SourceTerminal,SESECD_1.0.0) */
// 自定义代码
