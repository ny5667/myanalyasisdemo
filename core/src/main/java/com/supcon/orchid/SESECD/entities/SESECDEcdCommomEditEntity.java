...
public class SESECDEcdCommomEditEntity implements Serializable {
	...
	private SESECDEcdCommom ecdCommom;

	public SESECDEcdCommom getEcdCommom(){
		return ecdCommom;
	}

	public void setEcdCommom(SESECDEcdCommom ecdCommom){
		this.ecdCommom = ecdCommom;
	}
}