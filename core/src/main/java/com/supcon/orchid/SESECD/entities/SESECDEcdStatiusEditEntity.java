...
public class SESECDEcdStatiusEditEntity implements Serializable {
	...
	private SESECDEcdStatius ecdStatius;

	public SESECDEcdStatius getEcdStatius(){
		return ecdStatius;
	}

	public void setEcdStatius(SESECDEcdStatius ecdStatius){
		this.ecdStatius = ecdStatius;
	}
}