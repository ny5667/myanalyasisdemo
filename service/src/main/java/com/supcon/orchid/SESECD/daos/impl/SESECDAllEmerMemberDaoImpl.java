...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_addrBook_AllEmerMember,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDAllEmerMemberDaoImpl extends TreeDaoImpl<SESECDAllEmerMember, Long> implements SESECDAllEmerMemberDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_addrBook_AllEmerMember,SESECD_1.0.0) */
// 自定义代码
