...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_Communication,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDCommunicationDaoImpl extends ExtendedGenericDaoImpl<SESECDCommunication, Long> implements SESECDCommunicationDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_Communication,SESECD_1.0.0) */
// 自定义代码
