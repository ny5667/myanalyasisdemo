...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_paramConfig_ParamOption,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDParamOptionDaoImpl extends ExtendedGenericDaoImpl<SESECDParamOption, Long> implements SESECDParamOptionDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_paramConfig_ParamOption,SESECD_1.0.0) */
// 自定义代码
