  ...
  if (eventId != undefined && eventId != "" && eventId != null) {
    ...
    ReactAPI.request({
      ...
      if (res.code == 200) {
        ...
        var grid = ReactAPI.getComponentAPI("SupDataGrid").APIs("SESECD_1.0.0_ecdPanel_ecdActionList_ecdAction_sdg");
        var Arry = new Array();
...
function setActionClickEvent() {
  ReactAPI.getComponentAPI("SupDataGrid").APIs("SESECD_1.0.0_ecdPanel_ecdActionList_ecdAction_sdg").setClickEvt(function (e, data) {
    var msg = {
      data: {
