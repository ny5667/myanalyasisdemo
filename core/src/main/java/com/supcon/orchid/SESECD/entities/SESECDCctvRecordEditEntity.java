...
public class SESECDCctvRecordEditEntity implements Serializable {
	...
	private SESECDCctvRecord cctvRecord;

	public SESECDCctvRecord getCctvRecord(){
		return cctvRecord;
	}

	public void setCctvRecord(SESECDCctvRecord cctvRecord){
		this.cctvRecord = cctvRecord;
	}
}