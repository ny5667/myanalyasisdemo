...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_doorAccessControl_EntranceInfo,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEntranceInfoDaoImpl extends ExtendedGenericDaoImpl<SESECDEntranceInfo, Long> implements SESECDEntranceInfoDao {
	@Override
	...
	@Override
	public SESECDEntranceInfoDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDEntranceInfoDealInfo dealInfo = new SESECDEntranceInfoDealInfo();
	...
	@Override
	public SESECDEntranceInfoDealInfo copyAndSaveDealInfo(DealInfo di, SESECDEntranceInfo mainObj, Staff dealStaff) {
		SESECDEntranceInfoDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDEntranceInfoDealInfo.class);
		...
		List<SESECDEntranceInfoDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_doorAccessControl_EntranceInfo,SESECD_1.0.0) */
// 自定义代码
