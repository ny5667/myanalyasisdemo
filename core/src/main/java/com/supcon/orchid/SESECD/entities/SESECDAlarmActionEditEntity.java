...
public class SESECDAlarmActionEditEntity implements Serializable {
	...
	private SESECDAlarmAction alarmAction;

	public SESECDAlarmAction getAlarmAction(){
		return alarmAction;
	}

	public void setAlarmAction(SESECDAlarmAction alarmAction){
