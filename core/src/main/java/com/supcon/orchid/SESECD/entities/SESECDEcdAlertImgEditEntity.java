...
public class SESECDEcdAlertImgEditEntity implements Serializable {
	...
	private SESECDEcdAlertImg ecdAlertImg;

	public SESECDEcdAlertImg getEcdAlertImg(){
		return ecdAlertImg;
	}

	public void setEcdAlertImg(SESECDEcdAlertImg ecdAlertImg){
		this.ecdAlertImg = ecdAlertImg;
	}
}