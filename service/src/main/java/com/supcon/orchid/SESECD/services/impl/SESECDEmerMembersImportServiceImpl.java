...
@Service("sESECDEmerMembersImportService")
public class SESECDEmerMembersImportServiceImpl implements SESECDEmerMembersImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_addrBook",model="SESECD_1.0.0_addrBook_EmerMembers",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmerMembers bizObj, SESECDEmerMembers oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmerMembers bizObj, String bussinesskeyFieldName,
