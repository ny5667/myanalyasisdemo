...
public class SESECDAccidentEditEntity implements Serializable {
	...
	private SESECDAccident accident;

	public SESECDAccident getAccident(){
		return accident;
	}

	public void setAccident(SESECDAccident accident){
