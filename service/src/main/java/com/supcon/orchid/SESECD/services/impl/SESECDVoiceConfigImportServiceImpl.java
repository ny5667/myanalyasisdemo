...
@Service("sESECDVoiceConfigImportService")
public class SESECDVoiceConfigImportServiceImpl implements SESECDVoiceConfigImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_voiceConfig",model="SESECD_1.0.0_voiceConfig_VoiceConfig",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDVoiceConfig bizObj, SESECDVoiceConfig oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1676006291416") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1676006291416") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDVoiceConfig bizObj, String bussinesskeyFieldName,
