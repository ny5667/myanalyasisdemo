...
/* CUSTOM CODE START(controller,import,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码
...
@Api
public class SESECDEmEventLeveLController extends BaseController<SESECDEmEventLeveL> {
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelList-query", produces = "application/json")
	@ResponseBody
	public String emEventLevelListListQuery(@RequestBody(required = false) QueryEntity queryEntity, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Page<SESECDEmEventLeveL> page = new Page<SESECDEmEventLeveL>();
		...
		bapBeforeCustomMethod(viewCode, "emEventLevelListListQuery", queryEntity);
		int currentSqlType = Sql.TYPE_LIST_QUERY;
		emEventLeveLService.listQuery(page, currentSqlType, viewCode, datagridCode, null, queryEntity.getProcessKey(),
		...
		if(!queryEntity.isExportFlag()){
			bapAfterCustomMethod(viewCode, "emEventLevelListListQuery", page);
		}
		String includes = "first,hasNext,hasPre,nextPage,pageSize,pageNo,prePage,totalCount,totalPages,treeToSurfaceMode,result.pending.id,result.pending.taskDescription,result.pending.openUrl,result.pending.userId,result.tableInfoId,result.id,result.version,result.valid,result.cid,result.cidName,result.layRec,result.status,result.tableNo,result.createStaff.name,result.createTime,result.emEventLevel,result.gradingDefinition,result.isInitialize,result.pending.processDescription,result.pending.processId,result.pending.deploymentId,result.pending.bulkDealFlag,result.pending.activityType,result.pending.activityName,result.pending.processKey,result.pending.processVersion,result.createStaff.attrMap.*,result.deleteStaff.attrMap.*,result.effectStaff.attrMap.*,result.modifyStaff.attrMap.*,result.ownerDepartment.attrMap.*,result.ownerPosition.attrMap.*,result.ownerStaff.attrMap.*,result.*.attrMap.*";
		String excludes = "*";
		...
		if(queryEntity.isExportFlag()){
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode("SESECD_1.0.0_emEventInfo_EmEventLeveL.xls", "UTF-8"));
			Model model = modelServiceFoundation.getModel("SESECD_1.0.0_emEventInfo_EmEventLeveL");
			exportService.exportExcel(out,response, model, page, viewCode);
			emEventLeveLService.excelExport();
			return null;
		}
    	 ...
    	 * @throws Exception
    	 */
    	@PostMapping(value = "/SESECD/emEventInfo/emEventLeveL/proj/{viewName}-query", produces = "application/json")
    	@ResponseBody
	...
	private void getFullObject(Page<SESECDEmEventLeveL> page){
		List<SESECDEmEventLeveL> emEventLeveLs = page.getResult();
		List<Long> ids = emEventLeveLs.stream().map(SESECDEmEventLeveL::getId).collect(Collectors.toList());
        page.setResult(emEventLeveLService.findSESECDEmEventLeveLByIds(ids));
	}
	 ...
	 *  参照视图公用数据查询方法
	*/
	@PostMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelRef-query", produces = "application/json")
	@ResponseBody
	public String emEventLevelRefListQuery(@RequestBody(required = false) QueryEntity queryEntity, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Page<SESECDEmEventLeveL> page = new Page<SESECDEmEventLeveL>();
		page.setPageSize(queryEntity.getPageSize());
		page.setPageNo(queryEntity.getPageNo());
		page.setPaging(queryEntity.isPaging());
		...
		bapBeforeCustomMethod(viewCode, "emEventLevelRefListQuery", queryEntity);
		...
		// 实体未启用工作流
		emEventLeveLService.listQuery(page, currentSqlType, viewCode, null, queryEntity.getCrossCompanyFlag(), null,
			...
			queryEntity.getExportSql(), findExportDataInfosCount, queryEntity.getDynamicFieldsMap(),queryEntity);
		if(!queryEntity.isExportFlag()){
            bapAfterCustomMethod(viewCode, "emEventLevelRefListQuery", page);
        }
		String includes = "first,hasNext,hasPre,nextPage,pageSize,pageNo,prePage,totalCount,totalPages,treeToSurfaceMode,result.pending.id,result.pending.taskDescription,result.pending.openUrl,result.pending.userId,result.tableInfoId,result.id,result.version,result.valid,result.cid,result.cidName,result.layRec,result.status,result.tableNo,result.createStaff.name,result.createTime,result.emEventLevel,result.gradingDefinition,result.*.attrMap.*,data.id,data.value";
		View view = viewServiceFoundation.getViewForMethodCheckInherit(viewCode);
        if(view != null){
            if(null!=view.getProjFlag() && view.getProjFlag() && null != view.getInheritType() && view.getInheritType()==2){
               includes= viewServiceFoundation.generateProjectViewResultField(viewCode);
...
@PostMapping(value = "/SESECD/emEventInfo/emEventLeveL/projref/{viewName}-query", produces = "application/json")
    	@ResponseBody
	...
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/selectData", produces = "application/json")
	@ResponseBody
	public String selectData(String includes) throws Exception {
		Page<SESECDEmEventLeveL> page = new Page<SESECDEmEventLeveL>();
		page.setPageSize(page.getMaxPageSize());
		List<SESECDEmEventLeveL> result = emEventLeveLService.findEmEventLeveLsByHql("from " + SESECDEmEventLeveL.JPA_NAME + " where valid =1");
...
/**
	...
	*/
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = {"/SESECD/emEventInfo/emEventLeveL/data/{id}",
		"/SESECD/emEventInfo/emEventLeveL/proj/data/{id}"}, produces = "application/json")
	@ResponseBody
	public Object getData(@PathVariable long id, Long pendingId, String includes, HttpServletRequest request) throws Exception {
		SESECDEmEventLeveL result = emEventLeveLService.getEmEventLeveL(id,pendingService.getViewCodeByPending(pendingId));
		// 返回图片类型字段信息
	 ...
	 */
	@PostMapping(value = {
		"/SESECD/emEventInfo/emEventLeveL/emEventLevelView/save",
		"/SESECD/emEventInfo/emEventLeveL/emEventLevelEdit/save",
		"/SESECD/emEventInfo/emEventLeveL/emEventLevelView/submit",
		"/SESECD/emEventInfo/emEventLeveL/emEventLevelEdit/submit",
		}, produces = "application/json")
	@ResponseBody
	public Object submit(Long id, HttpServletRequest request) throws Exception {
		SESECDEmEventLeveLEditEntity editEntity;
		ObjectMapper objectMapper = new ObjectMapper();
		objectMapper.configure(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY, true);
		objectMapper.configure(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT, true) ;
		objectMapper.enable(DeserializationFeature.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT);
		objectMapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
		bapBeforeCustomMethod("SESECD_1.0.0_emEventInfo_EmEventLeveL", "submit", null);
		if (null != id) {
			SESECDEmEventLeveL ordinaryEmEventLeveL = emEventLeveLService.getEmEventLeveLWithoutMultiselect(id);
			// 前端传的json
			...
			Map<String,Object> emEventLeveLMap = (Map<String, Object>) editEntityMap.get("emEventLeveL");
			editEntity = objectMapper.readValue(body, SESECDEmEventLeveLEditEntity.class);
			SESECDEmEventLeveL emEventLeveL = editEntity.getEmEventLeveL();
			// 只更新前端传的，其他按数据库里原有的数据
			for (Field field : ReflectUtils.getDeepDeclaredFields(SESECDEmEventLeveL.class)) {
				// 前端没传，继续遍历下一个字段
				if (null == emEventLeveLMap.get(field.getName())) {
					continue;
				}
				field.setAccessible(true);
				// 实际更新
				field.set(ordinaryEmEventLeveL, field.get(emEventLeveL));
			}
			editEntity.setEmEventLeveL(ordinaryEmEventLeveL);
		} else {
			editEntity = objectMapper.readValue(request.getAttribute("body").toString(), SESECDEmEventLeveLEditEntity.class);
		}
		SESECDEmEventLeveL emEventLeveL = editEntity.getEmEventLeveL();
        ...
        try {
            responseMap = emEventLeveLService.submit(emEventLeveL, editEntity.getWorkFlowVar(),
            ...
            // 如果模型需要审计
            boolean modelNeedAudit = ModelAuditLogCache.isAuditLogEnabled("SESECD_1.0.0_emEventInfo_EmEventLeveL", AuditLogType.BUSINESS);
            if (modelNeedAudit) {
                ...
                auditBusinessLogBO.setMainModelCode("SESECD_1.0.0_emEventInfo_EmEventLeveL");
                auditBusinessLogBO.setMainModelName("SESECD.emEventInfo.EmEventLeveL");
                auditBusinessLogBO.setMainEntityCode("SESECD_1.0.0_emEventInfo");
                auditBusinessLogBO.setMainEntityName("SESECD.entityname.randon1691460842170");
                auditBusinessLogStrategy.publishAuditLogLazy(auditBusinessLogBO);
            }
        }
        afterSubmitAtNewTransactionCustomMethod(editEntity.getViewCode(), "submit", emEventLeveL);
		...
		fileuploads.put("linkId", emEventLeveL.getId());
		request.setAttribute("__orchid_fileuploads__", fileuploads);
		bapAfterCustomMethod("SESECD_1.0.0_emEventInfo_EmEventLeveL", "submit", null);
		return responseMap;
	}
...
/**
    	 ...
    	 */
    	@PostMapping(value = {
    		"/SESECD/emEventInfo/emEventLeveL/proj/{viewName}/save",
    		"/SESECD/emEventInfo/emEventLeveL/proj/{viewName}/submit"
    		}, produces = "application/json")
    	@ResponseBody
	 ...
	 * 判断进入submit接口的操作类型
	 */
	private OperateType getSubmitOperateType(Long id, SESECDEmEventLeveLEditEntity editEntity) {
        // 超级编辑
	...
	/**
	 * 打开页面emEventLevelList
	 * url:/SESECD/emEventInfo/emEventLeveL/emEventLevelList
	 * @return
	 */
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelList")
	public String emEventLevelListView(@RequestParam(value = "clientType",required = false) String clientType) {
	    String viewName = bapBeforeReturnHtmlMethod("SESECD_1.0.0_emEventInfo_emEventLevelList", "emEventLevelListView", clientType);
        if (viewName != null) {
            return viewName;
        }
		if("mobile".equals(clientType)&&hasMobileView("SESECD_1.0.0_emEventInfo_emEventLevelList")){
			return "emEventLevelList-mobile.html";
		}
		return "emEventLevelList.html";
	}
	/**
	 * 打开页面emEventLevelView
	 * url:/SESECD/emEventInfo/emEventLeveL/emEventLevelView
	 * @return
	 */
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelView")
	public String emEventLevelViewView(@RequestParam(value = "clientType",required = false) String clientType) {
	    String viewName = bapBeforeReturnHtmlMethod("SESECD_1.0.0_emEventInfo_emEventLevelView", "emEventLevelViewView", clientType);
        if (viewName != null) {
            return viewName;
        }
		if("mobile".equals(clientType)&&hasMobileView("SESECD_1.0.0_emEventInfo_emEventLevelView")){
			return "emEventLevelView-mobile.html";
		}
		return "emEventLevelView.html";
	}
	/**
	 * 打开页面emEventLevelEdit
	 * url:/SESECD/emEventInfo/emEventLeveL/emEventLevelEdit
	 * @return
	 */
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelEdit")
	public String emEventLevelEditView(@RequestParam(value = "clientType",required = false) String clientType) {
	    String viewName = bapBeforeReturnHtmlMethod("SESECD_1.0.0_emEventInfo_emEventLevelEdit", "emEventLevelEditView", clientType);
        if (viewName != null) {
            return viewName;
        }
		if("mobile".equals(clientType)&&hasMobileView("SESECD_1.0.0_emEventInfo_emEventLevelEdit")){
			return "emEventLevelEdit-mobile.html";
		}
		return "emEventLevelEdit.html";
	}
	/**
	 * 打开页面emEventLevelRef
	 * url:/SESECD/emEventInfo/emEventLeveL/emEventLevelRef
	 * @return
	 */
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/emEventLevelRef")
	public String emEventLevelRefView(@RequestParam(value = "clientType",required = false) String clientType) {
	    String viewName = bapBeforeReturnHtmlMethod("SESECD_1.0.0_emEventInfo_emEventLevelRef", "emEventLevelRefView", clientType);
        if (viewName != null) {
            return viewName;
        }
		if("mobile".equals(clientType)&&hasMobileView("SESECD_1.0.0_emEventInfo_emEventLevelRef")){
			return "emEventLevelRef-mobile.html";
		}
		return "emEventLevelRef.html";
	}
    /**
	 * 打开页面
	 * url:
	 * @return
	 */
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/proj/{viewName}")
	public String projView(@RequestParam(value = "clientType",required = false) String clientType,@PathVariable String viewName,HttpServletRequest request) throws Exception {
		...
		emEventLeveLService.generateHtmlFile(request.getRequestURI(), projViewRelevantPath);
		return projViewRelevantPath;
	}
	...
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/editStates", produces = "application/json")
	@ResponseBody
	public String editStates(Long id, String viewCode, Long tableInfoId) throws Exception {
		...
		if (null == id) {
			...
			// 修改
			Map<String, Long> createInfoMap = emEventLeveLService.getCreateInfoMap(id);
	 ...
	 * @throws Exception
	 */
	@PostMapping("/SESECD/emEventInfo/emEventLeveL/delete")
	@ResponseBody
	@AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
                      operateType = OperateType.DELETE,
                      modelCodes = {"SESECD_1.0.0_emEventInfo_EmEventLeveL"},
                      mainModelCode = "SESECD_1.0.0_emEventInfo_EmEventLeveL",
                      mainModelName = "SESECD.emEventInfo.EmEventLeveL",
                      mainEntityCode = "SESECD_1.0.0_emEventInfo",
                      mainEntityName = "SESECD.entityname.randon1691460842170",
                      isLazy = true
    )		
	public Map<String, Object> delete(String ids, HttpServletRequest request) throws Exception {
		...
		emEventLeveLService.deleteEmEventLeveL(ids, signatureLog);
		Map<String, Object> responseMap = new HashMap<>();
	 ...
	 */
	@PostMapping(value = {
	    "/SESECD/emEventInfo/emEventLeveL/data-{dg.name}",
		"/SESECD/emEventInfo/emEventLeveL/proj/data-{dg.name}"
	...
	public String dataGridData(Long id, Long refId, String datagridCode, @RequestBody(required = false)QueryEntity queryEntity,
			...
			DataGrid dg = viewServiceFoundation.getDataGrid(datagridCode);
            		if(dg !=null && dg.getDataGridType()==1){
                        ...
                        emEventLeveLService.dataGridData(dgPage, datagridCode, dataGridName, request.getParameterMap(), refId,id,queryEntity);
	...
	@GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/echartsData", produces = "application/json")
	@ResponseBody
	...
	@GetMapping(value = {"/SESECD/emEventInfo/emEventLeveL/importMainXls","/SESECD/emEventInfo/emEventLeveL/proj/importMainXls"}, produces = "application/json")
	@ResponseBody
	public Object importMainXls(String filePath, String viewCode, boolean isReplace, boolean isIgnore, HttpServletRequest request) {
		Object[] importServices = new Object[]{"com.supcon.orchid.SESECD.services.SESECDEmEventLeveLService"
		...
		List<CustomPropertyModelMapping> list = modelServiceFoundation.getCustomPropertiesWithType("SESECD_1.0.0_emEventInfo", DbColumnType.OBJECT);
		...
		List<Model> models = modelServiceFoundation.getModels("SESECD_1.0.0_emEventInfo");
		for(Model m : models){
			...
			if(dataFile != null){
                ...
                if (getSTATE() == 0) {
					synchronized (this) {
						changeState(0);
						try {
				            xlsResult = importService.batchImports(viewCode, "SESECD_1.0.0_emEventInfo_EmEventLeveL", dataFile, time, name, isReplace, isIgnore, true, "xls", signatureLog, newService);
                        } finally {
                            changeState(1);
                        }
                    }
    ...
    @GetMapping(value = {"/SESECD/emEventInfo/emEventLeveL/importXls","/SESECD/emEventInfo/emEventLeveL/proj/importXls"}, produces = "application/json")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@GetMapping(value = {"/SESECD/emEventInfo/emEventLeveL/downloadXls","/SESECD/emEventInfo/emEventLeveL/proj/downloadXls"})
	@ResponseBody
    ...
    @GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/networkPrint", produces = "application/json")
	@ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
	...
	public String print(String printerName,String templateCode,Long id,Integer count,String modelCode,HttpServletRequest request){
		SESECDEmEventLeveL emEventLeveL=emEventLeveLService.getEmEventLeveL(id);
		...
		if (isSuccess) {
			...
			try {
				result = printClientService.doPrintInfo(emEventLeveL,templateCode, Long.valueOf(id), modelCode, printerName, Integer.valueOf(count),paramMap);
				if (!"SUCCESS".equals(result)) {
					isSuccess = false;
				}
			} catch (Exception e) {
    ...
    @GetMapping(value = "/SESECD/emEventInfo/emEventLeveL/printOnServer", produces = "application/json")
    @ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
                      operateType = OperateType.PRINT,
    ...
    public Map<String, Object> printOnServer(Long id, String templateCode, String viewCode, HttpServletRequest request) throws Exception {
    	SESECDEmEventLeveL emEventLeveL = null;
    	if(null != id) {
    		emEventLeveL = emEventLeveLService.getEmEventLeveL(id);
    	}
    //		String templateCode = request.getParameter("templateCode");
    	SignatureLog signatureLog = (SignatureLog)request.getAttribute("signatureLog");
    	String pdfFileName=printService.printOnServer(emEventLeveL,templateCode,viewCode, null,signatureLog);
    	printXmlInfo.put("pdfFileName", pdfFileName);
    	return printXmlInfo;
    }
    @PostMapping(value = "/SESECD/emEventInfo/emEventLeveL/batchPrintOnServer", produces = "application/json")
    @ResponseBody
    @AuditBusinessLog(moduleCode = "SESECD",
                      moduleName = "SESECD.modulename.randon1594690070190",
    ...
    public Map<String, Object> batchPrintOnServer(@RequestParam(value = "ids") String ids,
        ...
        if (ids != null && ids.length() > 0) {
            ...
            for (int i = 0; i < arrId.length; i++) {
                objs.add(emEventLeveLService.getEmEventLeveL(Long.parseLong(arrId[i])));
            }
        }
    ...
    */
    ...
    /* CUSTOM CODE START(controller,beforeReturnHtmlMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(controller,beforeMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码
...
/* CUSTOM CODE END */
	...
	/* CUSTOM CODE START(controller,afterMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
	}

	private void bapGetDataAfterCustomMethod(String methodName, SESECDEmEventLeveL result, String includes) throws Exception {
    /* CUSTOM CODE START(controller,getDataAfterMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
    private void bapBeforeRecallMethod(Long tableinfoId) throws Exception {
	/* CUSTOM CODE START(controller,beforeRecallMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
	}
	private void bapAfterRecallMethod(Long tableinfoId) throws Exception {
    /* CUSTOM CODE START(controller,afterRecallMethods,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
    private void afterSubmitAtNewTransactionCustomMethod(String viewCode, String methodName, SESECDEmEventLeveL result) throws Exception {
    /* CUSTOM CODE START(controller,afterSubmitAtNewTransaction,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
    }
	/* CUSTOM CODE START(controller,functions,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码
