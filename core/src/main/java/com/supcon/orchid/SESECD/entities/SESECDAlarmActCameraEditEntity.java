...
public class SESECDAlarmActCameraEditEntity implements Serializable {
	...
	private SESECDAlarmActCamera alarmActCamera;

	public SESECDAlarmActCamera getAlarmActCamera(){
		return alarmActCamera;
	}

	public void setAlarmActCamera(SESECDAlarmActCamera alarmActCamera){
		this.alarmActCamera = alarmActCamera;
	}
}