...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_broadcastIntercom_BroadcastInfo,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDBroadcastInfoDaoImpl extends ExtendedGenericDaoImpl<SESECDBroadcastInfo, Long> implements SESECDBroadcastInfoDao {
	@Override
	...
	@Override
	public SESECDBroadcastInfoDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDBroadcastInfoDealInfo dealInfo = new SESECDBroadcastInfoDealInfo();
	...
	@Override
	public SESECDBroadcastInfoDealInfo copyAndSaveDealInfo(DealInfo di, SESECDBroadcastInfo mainObj, Staff dealStaff) {
		SESECDBroadcastInfoDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDBroadcastInfoDealInfo.class);
		...
		List<SESECDBroadcastInfoDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_broadcastIntercom_BroadcastInfo,SESECD_1.0.0) */
// 自定义代码
