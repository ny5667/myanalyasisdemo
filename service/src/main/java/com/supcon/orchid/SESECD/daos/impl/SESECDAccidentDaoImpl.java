...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_Accident,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDAccidentDaoImpl extends ExtendedGenericDaoImpl<SESECDAccident, Long> implements SESECDAccidentDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_Accident,SESECD_1.0.0) */
// 自定义代码
