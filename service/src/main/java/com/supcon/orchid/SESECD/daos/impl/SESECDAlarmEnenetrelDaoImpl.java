...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDAlarmEnenetrelDaoImpl extends ExtendedGenericDaoImpl<SESECDAlarmEnenetrel, Long> implements SESECDAlarmEnenetrelDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_AlarmEnenetrel,SESECD_1.0.0) */
// 自定义代码
