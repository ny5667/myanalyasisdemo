...
/* CUSTOM CODE START(service,import,SESECD_1.0.0_tagConfig_TagConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */
public interface SESECDTagConfigService extends IBusinessKeyService {
	 ...
	 * @return
	 */
	void listQuery(Page<SESECDTagConfig> page, int currentSqlType, String viewCode, String datagridCode, Boolean crossCompanyFlag,
	 ...
	 * @return
	 */
	Map<String, Object> submit(SESECDTagConfig tagConfig, WorkFlowVar workFlowVar, Long pendingId,
	...
	*/
	 ...
	 * @return
	 */
	SESECDTagConfig getTagConfig(long id);
	 ...
	 * @return
	 */
	SESECDTagConfig getTagConfig(long id, String viewCode);

	/**
	 * 根据ID，获取 报警装置配置 对象,不包含多选控件信息
	 * @param id
	 * @return
	 */
	SESECDTagConfig getTagConfigWithoutMultiselect(long id);

	/**
	 * 根据ID，获取 报警装置配置 对象 并转化为JSON
	 * @param id
	 * @return
	 */
	String getTagConfigAsJSON(long id, String include);
	
	/**
	 * 根据ID，获取 报警装置配置 对象的创建人信息map
	 * @param id
	 * @return
	 */
	...
	/**
	 * 删除  报警装置配置 对象
	 * @param tagConfig 报警装置配置
	 */
	void deleteTagConfig(SESECDTagConfig tagConfig);
	 ...
	 * @param id
	 */
	void deleteTagConfig(long tagConfigId, int tagConfigVersion);

	/**
	 * 根据ID，删除  报警装置配置 对象
	 * @param id
	 */
	void deleteTagConfig(long tagConfigId, int tagConfigVersion,SignatureLog signatureLog);

	/**
	 * 根据ID串，删除多个  报警装置配置 对象
	 * @param tagConfigIds
	 */
	void deleteTagConfig(String tagConfigIds);

	/**
	 * 根据ID串，删除多个  报警装置配置 对象
	 * @param tagConfigIds
	 */
	void deleteTagConfig(String tagConfigIds,SignatureLog signatureLog);

	/**
	 * 根据ID，删除多个  报警装置配置 对象
	 * @param tagConfigIds
	 */
	void deleteTagConfig(List<Long> tagConfigIds);
	
	/**
	 * 根据ID，删除多个  报警装置配置 对象
	 * @param tagConfigIds
	 */
	void deleteTagConfig(List<Long> tagConfigIds, String eventTopic);

	/**
	 * 根据ID，还原  报警装置配置 对象
	 * @param tagConfigId
	 */
	void restoreTagConfig(String tagConfigIds);
	/**
	 * 根据ID，还原  报警装置配置 对象
	 * @param tagConfigId
	 */
	void restoreTagConfig(long tagConfigId);
	 ...
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode);
	
	void batchImportBaseTagConfig(List<SESECDTagConfig>  tagConfigs);
	
	void excelBatchImportBaseTagConfig(List<SESECDTagConfig>  tagConfigs);
	 ...
	 * @param assFileUploads DataGrid关联附件集合
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads);
	 ...
	 * @param assFileUploads DataGrid关联附件集合
	 */
	void saveTagConfig(SESECDTagConfig tagConfig,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode, String eventTopic,boolean... isImport);
	 ...
	 * @param assFileUploads DataGrid关联附件集合
	 */
	void saveTagConfig(SESECDTagConfig tagConfig,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads, String viewCode, String eventTopic,SignatureLog signatureLog,boolean... isImport);
	 ...
	 * 电子签名接口
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, DataGridService dataGridService, String viewCode, String eventTopic,SignatureLog signatureLog,boolean... isImport);
	 ...
	 * @param assFileUploads DataGrid关联附件集合
	 */
	void mergeTagConfig(SESECDTagConfig tagConfig, Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads);

	/**
	 * 根据条件(多条件)获取指定页码的 报警装置配置 集合
	 * 
	 * @param page
	 * @param criterions
	 * @return
	 */
	Page<SESECDTagConfig> findTagConfigs(Page<SESECDTagConfig> page,Criterion...criterions);
	 ...
	 * 保存处理意见
	 * 
	 * @param TagConfigDealInfo 报警装置配置DealInfo
	 * @return
	 */
	 ...
	 * @return
	 */
	void findTagConfigs(Page<SESECDTagConfig> page, String viewCode, int type,String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode,Boolean noQueryFlag,String exportSql, Map exportMap,QueryEntity queryEntity);
	 ...
	 * @return
	 */
	void findTagConfigs(Page<SESECDTagConfig> page, String viewCode, int type,String processKey,Boolean flowBulkFlag, Boolean hasAttachment, List<Param> params, String permissionCode,Boolean noQueryFlag,String exportSql, Map exportMap, QueryEntity queryEntity, Object... objects);
	 ...
	 * @return
	 */
	void findTagConfigs(Page<SESECDTagConfig> page, String viewCode, int type,String processKey,Boolean flowBulkFlag, Boolean hasAttachment,Boolean noQueryFlag, String exportSql, Map exportMap, List<Param> params,QueryEntity queryEntity);
	/**
	...
	List<SESECDTagConfig> getTagConfigs(String sql , List<Object> params);
	...
	SESECDTagConfig loadTagConfigByBussinessKey(SESECDTagConfig tagConfig);
	
	Page<SESECDTagConfig> getTagConfigs(Page<SESECDTagConfig> page, String sql , List<Object> params, String sort);
	 ...
	 */
	public Map<Object, Long> importBatchTagConfig(List<SESECDTagConfig> insertObjs, List<SESECDTagConfig> updateObjs, List<Map<String,String>> columnInfo, Map<String ,List<Map<String, Object>>> importNodeInfo, Map<String, Property> importPropInfo);
	 ...
	 * @param columnInfo excel中的列信息
	 */
	public Map<Object, Long> importBatchTagConfig(List<SESECDTagConfig> insertObjs, List<SESECDTagConfig> updateObjs, List<Map<String,String>> columnInfo, Map<String ,List<Map<String, Object>>> importNodeInfo, Map<String, Property> importPropInfo,SignatureLog signatureLog);
	 ...
	 * @param dataGridService DataGridService对象
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, DataGridService dataGridService, String viewCode);
	 ...
	 * @param dataGridService DataGridService对象
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, DataGridService dataGridService, String viewCode, String eventTopic,boolean... isImport);
	 ...
	 * @param dataGridService DataGridService对象
	 */
	void saveTagConfig(SESECDTagConfig tagConfig, DataGridService dataGridService);
	 ...
	 * @param dataGridService DataGridService对象
	 */
	Map<Object, Object> tagConfigDataGridImport(SESECDTagConfig tagConfig, DataGridService dataGridService, String viewCode, String eventTopic,Property businessKey, boolean isImport);
	 ...
	 * @param dataGridService DataGridService对象
	 */
	void mergeTagConfig(SESECDTagConfig tagConfig, DataGridService dataGridService);
	 ...
	 * 获取分页
	 */
	Page<SESECDTagConfig> getByPage(Page<SESECDTagConfig> page,
			DetachedCriteria detachedCriteria);
	
	
	
	
	void findBusinessKeyUsed(long tagConfigId);
	
	void generateTagConfigCodes(SESECDTagConfig tagConfig) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException;
	
	void generateTagConfigCodes(SESECDTagConfig tagConfig, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException;
	
	void generateTagConfigSummarys(SESECDTagConfig tagConfig) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException;
	
	void generateTagConfigSummarys(SESECDTagConfig tagConfig, Boolean viewIsView) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException;
	
	String generateCustomPropertySql(String viewCode, String datagridCode, String sql);
	
	void commonQuery(Page<SESECDTagConfig> page, String viewCode, int type, String processKey, Boolean flowBulkFlag,
	...
	void checkUniqueConstraint(SESECDTagConfig tagConfig);
	
	void dealDatagridsSave(SESECDTagConfig tagConfig,String viewCode,Map<String,String> dgLists,Map<String,String> dgDeleteIDs,Map<String,Object> assFileUploads);
	
	String generateTableNo();

    List<SESECDTagConfig> findSESECDTagConfigByIds(List<Long> ids);

    Map<String,SESECDTagConfig> findTagConfigByBussinessKeys(String bussinessKeys);

	void generateHtmlFile(String url, String projViewPath) throws Exception;

	/* CUSTOM CODE START(service,functions,SESECD_1.0.0_tagConfig_TagConfig,SESECD_1.0.0) */
// 自定义代码
