...
public class SESECDMesPersonEditEntity implements Serializable {
	...
	private SESECDMesPerson mesPerson;

	public SESECDMesPerson getMesPerson(){
		return mesPerson;
	}

	public void setMesPerson(SESECDMesPerson mesPerson){
