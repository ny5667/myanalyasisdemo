...
public class SESECDActionOwnersEditEntity implements Serializable {
	...
	private SESECDActionOwners actionOwners;

	public SESECDActionOwners getActionOwners(){
		return actionOwners;
	}

	public void setActionOwners(SESECDActionOwners actionOwners){
