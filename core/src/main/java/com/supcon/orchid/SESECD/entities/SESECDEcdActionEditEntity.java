...
public class SESECDEcdActionEditEntity implements Serializable {
	...
	private SESECDEcdAction ecdAction;

	public SESECDEcdAction getEcdAction(){
		return ecdAction;
	}

	public void setEcdAction(SESECDEcdAction ecdAction){
