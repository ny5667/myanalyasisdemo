...
@Service("sESECDCctvRecordImportService")
public class SESECDCctvRecordImportServiceImpl implements SESECDCctvRecordImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_CctvRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDCctvRecord bizObj, SESECDCctvRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDCctvRecord bizObj, String bussinesskeyFieldName,
