...
@Service("sESECDSourceTerminalImportService")
public class SESECDSourceTerminalImportServiceImpl implements SESECDSourceTerminalImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_signalConfig",model="SESECD_1.0.0_signalConfig_SourceTerminal",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDSourceTerminal bizObj, SESECDSourceTerminal oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1616052129981") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1616052129981") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDSourceTerminal bizObj, String bussinesskeyFieldName,
