...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_voiceConfig_VoiceConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDVoiceConfigDaoImpl extends ExtendedGenericDaoImpl<SESECDVoiceConfig, Long> implements SESECDVoiceConfigDao {
	@Override
	...
	@Override
	public SESECDVoiceConfigDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDVoiceConfigDealInfo dealInfo = new SESECDVoiceConfigDealInfo();
	...
	@Override
	public SESECDVoiceConfigDealInfo copyAndSaveDealInfo(DealInfo di, SESECDVoiceConfig mainObj, Staff dealStaff) {
		SESECDVoiceConfigDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDVoiceConfigDealInfo.class);
		...
		List<SESECDVoiceConfigDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_voiceConfig_VoiceConfig,SESECD_1.0.0) */
// 自定义代码
