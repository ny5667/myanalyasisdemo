...
@Service("sESECDVoiceMemberImportService")
public class SESECDVoiceMemberImportServiceImpl implements SESECDVoiceMemberImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_voiceConfig",model="SESECD_1.0.0_voiceConfig_VoiceMember",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDVoiceMember bizObj, SESECDVoiceMember oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDVoiceMember bizObj, String bussinesskeyFieldName,
