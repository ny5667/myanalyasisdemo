...
@Service("sESECDEmcSituationImportService")
public class SESECDEmcSituationImportServiceImpl implements SESECDEmcSituationImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emcSituation",model="SESECD_1.0.0_emcSituation_EmcSituation",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmcSituation bizObj, SESECDEmcSituation oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1577176777829") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1577176777829") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmcSituation bizObj, String bussinesskeyFieldName,
