...
public class SESECDEcdParamConfigEditEntity implements Serializable {
	...
	private SESECDEcdParamConfig ecdParamConfig;

	public SESECDEcdParamConfig getEcdParamConfig(){
		return ecdParamConfig;
	}

	public void setEcdParamConfig(SESECDEcdParamConfig ecdParamConfig){
		this.ecdParamConfig = ecdParamConfig;
	}
}