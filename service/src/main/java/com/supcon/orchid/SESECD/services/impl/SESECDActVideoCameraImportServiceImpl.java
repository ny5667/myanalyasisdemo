...
@Service("sESECDActVideoCameraImportService")
public class SESECDActVideoCameraImportServiceImpl implements SESECDActVideoCameraImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emcAction",model="SESECD_1.0.0_emcAction_ActVideoCamera",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDActVideoCamera bizObj, SESECDActVideoCamera oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDActVideoCamera bizObj, String bussinesskeyFieldName,
