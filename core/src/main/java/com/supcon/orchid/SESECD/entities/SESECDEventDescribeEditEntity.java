...
public class SESECDEventDescribeEditEntity implements Serializable {
	...
	private SESECDEventDescribe eventDescribe;

	public SESECDEventDescribe getEventDescribe(){
		return eventDescribe;
	}

	public void setEventDescribe(SESECDEventDescribe eventDescribe){
