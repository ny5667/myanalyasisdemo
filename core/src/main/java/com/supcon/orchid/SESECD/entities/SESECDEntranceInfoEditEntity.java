...
public class SESECDEntranceInfoEditEntity implements Serializable {
	...
	private SESECDEntranceInfo entranceInfo;

	public SESECDEntranceInfo getEntranceInfo(){
		return entranceInfo;
	}

	public void setEntranceInfo(SESECDEntranceInfo entranceInfo){
