...
@Service("sESECDEcdParamConfigImportService")
public class SESECDEcdParamConfigImportServiceImpl implements SESECDEcdParamConfigImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_paramConfig",model="SESECD_1.0.0_paramConfig_EcdParamConfig",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdParamConfig bizObj, SESECDEcdParamConfig oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1685348810371") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1685348810371") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdParamConfig bizObj, String bussinesskeyFieldName,
