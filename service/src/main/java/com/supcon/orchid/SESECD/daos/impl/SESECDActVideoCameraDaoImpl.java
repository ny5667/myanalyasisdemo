...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_emcAction_ActVideoCamera,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDActVideoCameraDaoImpl extends ExtendedGenericDaoImpl<SESECDActVideoCamera, Long> implements SESECDActVideoCameraDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_emcAction_ActVideoCamera,SESECD_1.0.0) */
// 自定义代码
