...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_AlarmAction,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDAlarmActionDaoImpl extends ExtendedGenericDaoImpl<SESECDAlarmAction, Long> implements SESECDAlarmActionDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_AlarmAction,SESECD_1.0.0) */
// 自定义代码
