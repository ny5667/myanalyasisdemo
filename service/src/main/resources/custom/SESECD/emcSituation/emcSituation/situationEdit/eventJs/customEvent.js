...
/*==================================callback=callbackDrillPlan(obj)事件==================================*/
function callbackDrillPlan(obj){
   drillPlan(obj);
}
...
ReactAPI.getComponentAPI()
  .TextArea.APIs("emcSituation.describtion")
...
debugger;
var aaa = ReactAPI.getComponentAPI().SystemCode.APIs('emcSituation.situationType').getValue().value;
if(aaa=="SESECD_situation_type/001"){
