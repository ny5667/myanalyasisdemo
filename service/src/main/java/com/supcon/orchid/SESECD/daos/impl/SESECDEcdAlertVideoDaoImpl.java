...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_ecdAlertRecord_EcdAlertVideo,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEcdAlertVideoDaoImpl extends ExtendedGenericDaoImpl<SESECDEcdAlertVideo, Long> implements SESECDEcdAlertVideoDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_ecdAlertRecord_EcdAlertVideo,SESECD_1.0.0) */
// 自定义代码
