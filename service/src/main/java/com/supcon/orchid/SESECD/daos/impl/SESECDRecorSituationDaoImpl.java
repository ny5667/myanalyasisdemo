...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_RecorSituation,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDRecorSituationDaoImpl extends ExtendedGenericDaoImpl<SESECDRecorSituation, Long> implements SESECDRecorSituationDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_RecorSituation,SESECD_1.0.0) */
// 自定义代码
