...
@Service("sESECDRecordActionImportService")
public class SESECDRecordActionImportServiceImpl implements SESECDRecordActionImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_RecordAction",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDRecordAction bizObj, SESECDRecordAction oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDRecordAction bizObj, String bussinesskeyFieldName,
