...
public class SESECDMainPeopleEditEntity implements Serializable {
	...
	private SESECDMainPeople mainPeople;

	public SESECDMainPeople getMainPeople(){
		return mainPeople;
	}

	public void setMainPeople(SESECDMainPeople mainPeople){
