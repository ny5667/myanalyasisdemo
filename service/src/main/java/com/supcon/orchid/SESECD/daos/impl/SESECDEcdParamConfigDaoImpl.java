...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_paramConfig_EcdParamConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEcdParamConfigDaoImpl extends ExtendedGenericDaoImpl<SESECDEcdParamConfig, Long> implements SESECDEcdParamConfigDao {
	@Override
	...
	@Override
	public SESECDEcdParamConfigDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDEcdParamConfigDealInfo dealInfo = new SESECDEcdParamConfigDealInfo();
	...
	@Override
	public SESECDEcdParamConfigDealInfo copyAndSaveDealInfo(DealInfo di, SESECDEcdParamConfig mainObj, Staff dealStaff) {
		SESECDEcdParamConfigDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDEcdParamConfigDealInfo.class);
		...
		List<SESECDEcdParamConfigDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_paramConfig_EcdParamConfig,SESECD_1.0.0) */
// 自定义代码
