...
@Service("sESECDEcdAlertVideoImportService")
public class SESECDEcdAlertVideoImportServiceImpl implements SESECDEcdAlertVideoImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdAlertRecord",model="SESECD_1.0.0_ecdAlertRecord_EcdAlertVideo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdAlertVideo bizObj, SESECDEcdAlertVideo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdAlertVideo bizObj, String bussinesskeyFieldName,
