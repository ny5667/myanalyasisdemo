...
public class SESECDDispatConfigEditEntity implements Serializable {
	...
	private SESECDDispatConfig dispatConfig;

	public SESECDDispatConfig getDispatConfig(){
		return dispatConfig;
	}

	public void setDispatConfig(SESECDDispatConfig dispatConfig){
		this.dispatConfig = dispatConfig;
	}
}