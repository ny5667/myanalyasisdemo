...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_MesPerson,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDMesPersonDaoImpl extends ExtendedGenericDaoImpl<SESECDMesPerson, Long> implements SESECDMesPersonDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_MesPerson,SESECD_1.0.0) */
// 自定义代码
