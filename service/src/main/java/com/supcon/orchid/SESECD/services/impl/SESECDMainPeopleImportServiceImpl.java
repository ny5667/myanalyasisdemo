...
@Service("sESECDMainPeopleImportService")
public class SESECDMainPeopleImportServiceImpl implements SESECDMainPeopleImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emcAction",model="SESECD_1.0.0_emcAction_MainPeople",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDMainPeople bizObj, SESECDMainPeople oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDMainPeople bizObj, String bussinesskeyFieldName,
