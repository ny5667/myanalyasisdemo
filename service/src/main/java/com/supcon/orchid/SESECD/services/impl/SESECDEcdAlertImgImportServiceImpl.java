...
@Service("sESECDEcdAlertImgImportService")
public class SESECDEcdAlertImgImportServiceImpl implements SESECDEcdAlertImgImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdAlertRecord",model="SESECD_1.0.0_ecdAlertRecord_EcdAlertImg",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdAlertImg bizObj, SESECDEcdAlertImg oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdAlertImg bizObj, String bussinesskeyFieldName,
