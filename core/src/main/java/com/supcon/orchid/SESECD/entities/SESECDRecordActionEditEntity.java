...
public class SESECDRecordActionEditEntity implements Serializable {
	...
	private SESECDRecordAction recordAction;

	public SESECDRecordAction getRecordAction(){
		return recordAction;
	}

	public void setRecordAction(SESECDRecordAction recordAction){
