//页面加载事件
function pageLoad() {
	ReactAPI.getComponentAPI("SupDataGrid").APIs("SESECD_1.0.0_ecdAlertRecord_alertRecordList_ecdAlertRecord_sdg").setDbclickEvt(function (e, data) {
		// 如果需要单元格的双击事件处理,可使用data.currClickColKey的值做列判断
		console.log(data);
		var powerCode = 'SESECD_1.0.0_ecdAlertRecord_alertRecordList_self';
