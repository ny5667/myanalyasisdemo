...
@Service("sESECDEcdCommomImportService")
public class SESECDEcdCommomImportServiceImpl implements SESECDEcdCommomImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdPanel",model="SESECD_1.0.0_ecdPanel_EcdCommom",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdCommom bizObj, SESECDEcdCommom oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdCommom bizObj, String bussinesskeyFieldName,
