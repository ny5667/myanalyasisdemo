...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_ActionOwners,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDActionOwnersDaoImpl extends ExtendedGenericDaoImpl<SESECDActionOwners, Long> implements SESECDActionOwnersDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_ActionOwners,SESECD_1.0.0) */
// 自定义代码
