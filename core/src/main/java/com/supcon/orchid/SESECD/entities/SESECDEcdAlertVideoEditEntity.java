...
public class SESECDEcdAlertVideoEditEntity implements Serializable {
	...
	private SESECDEcdAlertVideo ecdAlertVideo;

	public SESECDEcdAlertVideo getEcdAlertVideo(){
		return ecdAlertVideo;
	}

	public void setEcdAlertVideo(SESECDEcdAlertVideo ecdAlertVideo){
		this.ecdAlertVideo = ecdAlertVideo;
	}
}