...
@Service("sESECDMesPersonImportService")
public class SESECDMesPersonImportServiceImpl implements SESECDMesPersonImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_MesPerson",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDMesPerson bizObj, SESECDMesPerson oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDMesPerson bizObj, String bussinesskeyFieldName,
