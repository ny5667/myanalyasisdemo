...
public class SESECDSourceTerminalEditEntity implements Serializable {
	...
	private SESECDSourceTerminal sourceTerminal;

	public SESECDSourceTerminal getSourceTerminal(){
		return sourceTerminal;
	}

	public void setSourceTerminal(SESECDSourceTerminal sourceTerminal){
