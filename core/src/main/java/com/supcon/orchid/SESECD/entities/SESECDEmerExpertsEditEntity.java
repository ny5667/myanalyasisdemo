...
public class SESECDEmerExpertsEditEntity implements Serializable {
	...
	private SESECDEmerExperts emerExperts;

	public SESECDEmerExperts getEmerExperts(){
		return emerExperts;
	}

	public void setEmerExperts(SESECDEmerExperts emerExperts){
		this.emerExperts = emerExperts;
	}
}