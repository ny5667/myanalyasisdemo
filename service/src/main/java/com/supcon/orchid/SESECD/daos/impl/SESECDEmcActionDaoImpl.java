...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_emcAction_EmcAction,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEmcActionDaoImpl extends ExtendedGenericDaoImpl<SESECDEmcAction, Long> implements SESECDEmcActionDao {
	@Override
	...
	@Override
	public SESECDEmcActionDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDEmcActionDealInfo dealInfo = new SESECDEmcActionDealInfo();
	...
	@Override
	public SESECDEmcActionDealInfo copyAndSaveDealInfo(DealInfo di, SESECDEmcAction mainObj, Staff dealStaff) {
		SESECDEmcActionDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDEmcActionDealInfo.class);
		...
		List<SESECDEmcActionDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_emcAction_EmcAction,SESECD_1.0.0) */
// 自定义代码
