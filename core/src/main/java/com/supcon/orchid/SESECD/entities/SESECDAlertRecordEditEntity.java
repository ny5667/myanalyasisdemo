...
public class SESECDAlertRecordEditEntity implements Serializable {
	...
	private SESECDAlertRecord alertRecord;

	public SESECDAlertRecord getAlertRecord(){
		return alertRecord;
	}

	public void setAlertRecord(SESECDAlertRecord alertRecord){
