...
@Service("sESECDAlmAlarmRecordImportService")
public class SESECDAlmAlarmRecordImportServiceImpl implements SESECDAlmAlarmRecordImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_AlmAlarmRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAlmAlarmRecord bizObj, SESECDAlmAlarmRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAlmAlarmRecord bizObj, String bussinesskeyFieldName,
