...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_tagConfig_TagConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDTagConfigDaoImpl extends ExtendedGenericDaoImpl<SESECDTagConfig, Long> implements SESECDTagConfigDao {
	@Override
	...
	@Override
	public SESECDTagConfigDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDTagConfigDealInfo dealInfo = new SESECDTagConfigDealInfo();
	...
	@Override
	public SESECDTagConfigDealInfo copyAndSaveDealInfo(DealInfo di, SESECDTagConfig mainObj, Staff dealStaff) {
		SESECDTagConfigDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDTagConfigDealInfo.class);
		...
		List<SESECDTagConfigDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_tagConfig_TagConfig,SESECD_1.0.0) */
// 自定义代码
