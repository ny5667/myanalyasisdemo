...
public class SESECDEmcSituationEditEntity implements Serializable {
	...
	private SESECDEmcSituation emcSituation;

	public SESECDEmcSituation getEmcSituation(){
		return emcSituation;
	}

	public void setEmcSituation(SESECDEmcSituation emcSituation){
		this.emcSituation = emcSituation;
	}
}