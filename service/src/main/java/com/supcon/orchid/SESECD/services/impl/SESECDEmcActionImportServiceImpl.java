...
@Service("sESECDEmcActionImportService")
public class SESECDEmcActionImportServiceImpl implements SESECDEmcActionImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emcAction",model="SESECD_1.0.0_emcAction_EmcAction",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmcAction bizObj, SESECDEmcAction oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmcAction bizObj, String bussinesskeyFieldName,
