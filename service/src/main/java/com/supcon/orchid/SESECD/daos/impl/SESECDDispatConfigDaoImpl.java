...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_dispatConfig_DispatConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDDispatConfigDaoImpl extends ExtendedGenericDaoImpl<SESECDDispatConfig, Long> implements SESECDDispatConfigDao {
	@Override
	...
	@Override
	public SESECDDispatConfigDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDDispatConfigDealInfo dealInfo = new SESECDDispatConfigDealInfo();
	...
	@Override
	public SESECDDispatConfigDealInfo copyAndSaveDealInfo(DealInfo di, SESECDDispatConfig mainObj, Staff dealStaff) {
		SESECDDispatConfigDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDDispatConfigDealInfo.class);
		...
		List<SESECDDispatConfigDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_dispatConfig_DispatConfig,SESECD_1.0.0) */
// 自定义代码
