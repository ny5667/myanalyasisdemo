...
public class SESECDTagConfigEditEntity implements Serializable {
	...
	private SESECDTagConfig tagConfig;

	public SESECDTagConfig getTagConfig(){
		return tagConfig;
	}

	public void setTagConfig(SESECDTagConfig tagConfig){
