...
@Service("sESECDChangeLogImportService")
public class SESECDChangeLogImportServiceImpl implements SESECDChangeLogImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_changeLog",model="SESECD_1.0.0_changeLog_ChangeLog",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDChangeLog bizObj, SESECDChangeLog oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1686550760182") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1686550760182") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDChangeLog bizObj, String bussinesskeyFieldName,
