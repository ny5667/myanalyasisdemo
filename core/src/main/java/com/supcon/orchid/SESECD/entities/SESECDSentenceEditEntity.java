...
public class SESECDSentenceEditEntity implements Serializable {
	...
	private SESECDSentence sentence;

	public SESECDSentence getSentence(){
		return sentence;
	}

	public void setSentence(SESECDSentence sentence){
