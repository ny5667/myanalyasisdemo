...
@Service("sESECDAllEmerMemberImportService")
public class SESECDAllEmerMemberImportServiceImpl implements SESECDAllEmerMemberImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_addrBook",model="SESECD_1.0.0_addrBook_AllEmerMember",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAllEmerMember bizObj, SESECDAllEmerMember oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1578313293886") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1578313293886") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAllEmerMember bizObj, String bussinesskeyFieldName,
