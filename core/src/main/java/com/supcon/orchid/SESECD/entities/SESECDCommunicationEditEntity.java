...
public class SESECDCommunicationEditEntity implements Serializable {
	...
	private SESECDCommunication communication;

	public SESECDCommunication getCommunication(){
		return communication;
	}

	public void setCommunication(SESECDCommunication communication){
