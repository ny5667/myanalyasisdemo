...
@Service("sESECDAlarmActionImportService")
public class SESECDAlarmActionImportServiceImpl implements SESECDAlarmActionImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_AlarmAction",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAlarmAction bizObj, SESECDAlarmAction oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAlarmAction bizObj, String bussinesskeyFieldName,
