...
@Service("sESECDSentenceImportService")
public class SESECDSentenceImportServiceImpl implements SESECDSentenceImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_situationSentence",model="SESECD_1.0.0_situationSentence_Sentence",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDSentence bizObj, SESECDSentence oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1615798472261") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1615798472261") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDSentence bizObj, String bussinesskeyFieldName,
