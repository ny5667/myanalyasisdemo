...
@Service("sESECDEcdStatiusImportService")
public class SESECDEcdStatiusImportServiceImpl implements SESECDEcdStatiusImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdPanel",model="SESECD_1.0.0_ecdPanel_EcdStatius",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdStatius bizObj, SESECDEcdStatius oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1578365471050") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1578365471050") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdStatius bizObj, String bussinesskeyFieldName,
