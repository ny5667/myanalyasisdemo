...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_addrBook_EmerMembers,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEmerMembersDaoImpl extends ExtendedGenericDaoImpl<SESECDEmerMembers, Long> implements SESECDEmerMembersDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_addrBook_EmerMembers,SESECD_1.0.0) */
// 自定义代码
