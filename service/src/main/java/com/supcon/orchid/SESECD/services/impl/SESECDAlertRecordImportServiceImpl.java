...
@Service("sESECDAlertRecordImportService")
public class SESECDAlertRecordImportServiceImpl implements SESECDAlertRecordImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alertRecord",model="SESECD_1.0.0_alertRecord_AlertRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAlertRecord bizObj, SESECDAlertRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1616139979666") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1616139979666") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAlertRecord bizObj, String bussinesskeyFieldName,
