...
@Service("sESECDRecorSituationImportService")
public class SESECDRecorSituationImportServiceImpl implements SESECDRecorSituationImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_RecorSituation",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDRecorSituation bizObj, SESECDRecorSituation oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDRecorSituation bizObj, String bussinesskeyFieldName,
