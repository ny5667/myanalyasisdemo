...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEmEventLeveLDaoImpl extends ExtendedGenericDaoImpl<SESECDEmEventLeveL, Long> implements SESECDEmEventLeveLDao {
	@Override
	...
	@Override
	public SESECDEmEventLeveLDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDEmEventLeveLDealInfo dealInfo = new SESECDEmEventLeveLDealInfo();
	...
	@Override
	public SESECDEmEventLeveLDealInfo copyAndSaveDealInfo(DealInfo di, SESECDEmEventLeveL mainObj, Staff dealStaff) {
		SESECDEmEventLeveLDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDEmEventLeveLDealInfo.class);
		...
		List<SESECDEmEventLeveLDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_emEventInfo_EmEventLeveL,SESECD_1.0.0) */
// 自定义代码
