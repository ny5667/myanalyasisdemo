...
@Service("sESECDEcdAlertRecordImportService")
public class SESECDEcdAlertRecordImportServiceImpl implements SESECDEcdAlertRecordImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdAlertRecord",model="SESECD_1.0.0_ecdAlertRecord_EcdAlertRecord",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdAlertRecord bizObj, SESECDEcdAlertRecord oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1685597767652") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1685597767652") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdAlertRecord bizObj, String bussinesskeyFieldName,
