...
public class SESECDAlarmEnenetrelEditEntity implements Serializable {
	...
	private SESECDAlarmEnenetrel alarmEnenetrel;

	public SESECDAlarmEnenetrel getAlarmEnenetrel(){
		return alarmEnenetrel;
	}

	public void setAlarmEnenetrel(SESECDAlarmEnenetrel alarmEnenetrel){
		this.alarmEnenetrel = alarmEnenetrel;
	}
}