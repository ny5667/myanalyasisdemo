...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_addrBook_EmerExperts,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEmerExpertsDaoImpl extends ExtendedGenericDaoImpl<SESECDEmerExperts, Long> implements SESECDEmerExpertsDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_addrBook_EmerExperts,SESECD_1.0.0) */
// 自定义代码
