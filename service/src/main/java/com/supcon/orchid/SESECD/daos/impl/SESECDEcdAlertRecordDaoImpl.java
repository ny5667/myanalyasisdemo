...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_ecdAlertRecord_EcdAlertRecord,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEcdAlertRecordDaoImpl extends ExtendedGenericDaoImpl<SESECDEcdAlertRecord, Long> implements SESECDEcdAlertRecordDao {
	@Override
	...
	@Override
	public SESECDEcdAlertRecordDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDEcdAlertRecordDealInfo dealInfo = new SESECDEcdAlertRecordDealInfo();
	...
	@Override
	public SESECDEcdAlertRecordDealInfo copyAndSaveDealInfo(DealInfo di, SESECDEcdAlertRecord mainObj, Staff dealStaff) {
		SESECDEcdAlertRecordDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDEcdAlertRecordDealInfo.class);
		...
		List<SESECDEcdAlertRecordDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_ecdAlertRecord_EcdAlertRecord,SESECD_1.0.0) */
// 自定义代码
