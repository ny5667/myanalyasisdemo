...
@Service("sESECDBroadcastInfoImportService")
public class SESECDBroadcastInfoImportServiceImpl implements SESECDBroadcastInfoImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_broadcastIntercom",model="SESECD_1.0.0_broadcastIntercom_BroadcastInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDBroadcastInfo bizObj, SESECDBroadcastInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1687656570445") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1687656570445") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDBroadcastInfo bizObj, String bussinesskeyFieldName,
