...
public class SESECDSignalConfigEditEntity implements Serializable {
	...
	private SESECDSignalConfig signalConfig;

	public SESECDSignalConfig getSignalConfig(){
		return signalConfig;
	}

	public void setSignalConfig(SESECDSignalConfig signalConfig){
