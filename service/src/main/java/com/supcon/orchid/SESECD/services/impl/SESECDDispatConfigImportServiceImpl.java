...
@Service("sESECDDispatConfigImportService")
public class SESECDDispatConfigImportServiceImpl implements SESECDDispatConfigImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_dispatConfig",model="SESECD_1.0.0_dispatConfig_DispatConfig",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDDispatConfig bizObj, SESECDDispatConfig oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1616490947704") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1616490947704") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDDispatConfig bizObj, String bussinesskeyFieldName,
