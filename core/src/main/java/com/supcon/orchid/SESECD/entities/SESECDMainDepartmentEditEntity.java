...
public class SESECDMainDepartmentEditEntity implements Serializable {
	...
	private SESECDMainDepartment mainDepartment;

	public SESECDMainDepartment getMainDepartment(){
		return mainDepartment;
	}

	public void setMainDepartment(SESECDMainDepartment mainDepartment){
