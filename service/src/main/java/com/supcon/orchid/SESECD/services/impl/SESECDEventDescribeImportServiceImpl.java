...
@Service("sESECDEventDescribeImportService")
public class SESECDEventDescribeImportServiceImpl implements SESECDEventDescribeImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_eventDescription",model="SESECD_1.0.0_eventDescription_EventDescribe",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEventDescribe bizObj, SESECDEventDescribe oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1615876348060") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1615876348060") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEventDescribe bizObj, String bussinesskeyFieldName,
