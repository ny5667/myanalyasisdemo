...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_ecdPanel_EcdStatius,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDEcdStatiusDaoImpl extends ExtendedGenericDaoImpl<SESECDEcdStatius, Long> implements SESECDEcdStatiusDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_ecdPanel_EcdStatius,SESECD_1.0.0) */
// 自定义代码
