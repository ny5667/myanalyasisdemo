...
@Service("sESECDMainDepartmentImportService")
public class SESECDMainDepartmentImportServiceImpl implements SESECDMainDepartmentImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emcAction",model="SESECD_1.0.0_emcAction_MainDepartment",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDMainDepartment bizObj, SESECDMainDepartment oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1577154773303") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1577154773303") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDMainDepartment bizObj, String bussinesskeyFieldName,
