...
@Service("sESECDEmEventTypeImportService")
public class SESECDEmEventTypeImportServiceImpl implements SESECDEmEventTypeImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emEventInfo",model="SESECD_1.0.0_emEventInfo_EmEventType",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmEventType bizObj, SESECDEmEventType oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmEventType bizObj, String bussinesskeyFieldName,
