...
public class SESECDActVideoCameraEditEntity implements Serializable {
	...
	private SESECDActVideoCamera actVideoCamera;

	public SESECDActVideoCamera getActVideoCamera(){
		return actVideoCamera;
	}

	public void setActVideoCamera(SESECDActVideoCamera actVideoCamera){
		this.actVideoCamera = actVideoCamera;
	}
}