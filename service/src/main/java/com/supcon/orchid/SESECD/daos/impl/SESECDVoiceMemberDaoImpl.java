...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_voiceConfig_VoiceMember,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDVoiceMemberDaoImpl extends ExtendedGenericDaoImpl<SESECDVoiceMember, Long> implements SESECDVoiceMemberDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_voiceConfig_VoiceMember,SESECD_1.0.0) */
// 自定义代码
