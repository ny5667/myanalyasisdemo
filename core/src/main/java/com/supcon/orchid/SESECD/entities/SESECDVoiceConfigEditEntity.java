...
public class SESECDVoiceConfigEditEntity implements Serializable {
	...
	private SESECDVoiceConfig voiceConfig;

	public SESECDVoiceConfig getVoiceConfig(){
		return voiceConfig;
	}

	public void setVoiceConfig(SESECDVoiceConfig voiceConfig){
