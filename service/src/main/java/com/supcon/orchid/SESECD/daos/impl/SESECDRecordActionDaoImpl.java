...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alarmRecord_RecordAction,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDRecordActionDaoImpl extends ExtendedGenericDaoImpl<SESECDRecordAction, Long> implements SESECDRecordActionDao {
	...
	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alarmRecord_RecordAction,SESECD_1.0.0) */
// 自定义代码
