...
@Service("sESECDAlarmEnenetrelImportService")
public class SESECDAlarmEnenetrelImportServiceImpl implements SESECDAlarmEnenetrelImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_AlarmEnenetrel",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAlarmEnenetrel bizObj, SESECDAlarmEnenetrel oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1576460940310") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1576460940310") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAlarmEnenetrel bizObj, String bussinesskeyFieldName,
