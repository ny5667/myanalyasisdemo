...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_alertRecord_AlertRecord,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDAlertRecordDaoImpl extends ExtendedGenericDaoImpl<SESECDAlertRecord, Long> implements SESECDAlertRecordDao {
	@Override
	...
	@Override
	public SESECDAlertRecordDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDAlertRecordDealInfo dealInfo = new SESECDAlertRecordDealInfo();
	...
	@Override
	public SESECDAlertRecordDealInfo copyAndSaveDealInfo(DealInfo di, SESECDAlertRecord mainObj, Staff dealStaff) {
		SESECDAlertRecordDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDAlertRecordDealInfo.class);
		...
		List<SESECDAlertRecordDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_alertRecord_AlertRecord,SESECD_1.0.0) */
// 自定义代码
