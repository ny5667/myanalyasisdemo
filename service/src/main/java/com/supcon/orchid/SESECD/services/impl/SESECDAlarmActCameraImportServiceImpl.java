...
@Service("sESECDAlarmActCameraImportService")
public class SESECDAlarmActCameraImportServiceImpl implements SESECDAlarmActCameraImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_AlarmActCamera",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAlarmActCamera bizObj, SESECDAlarmActCamera oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAlarmActCamera bizObj, String bussinesskeyFieldName,
