...
public class SESECDAllEmerMemberEditEntity implements Serializable {
	...
	private SESECDAllEmerMember allEmerMember;

	public SESECDAllEmerMember getAllEmerMember(){
		return allEmerMember;
	}

	public void setAllEmerMember(SESECDAllEmerMember allEmerMember){
		this.allEmerMember = allEmerMember;
	}
}