...
public class SESECDVoiceMemberEditEntity implements Serializable {
	...
	private SESECDVoiceMember voiceMember;

	public SESECDVoiceMember getVoiceMember(){
		return voiceMember;
	}

	public void setVoiceMember(SESECDVoiceMember voiceMember){
