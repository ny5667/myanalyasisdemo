...
@Service("sESECDEntranceInfoImportService")
public class SESECDEntranceInfoImportServiceImpl implements SESECDEntranceInfoImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_doorAccessControl",model="SESECD_1.0.0_doorAccessControl_EntranceInfo",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEntranceInfo bizObj, SESECDEntranceInfo oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1685683597808") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1685683597808") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEntranceInfo bizObj, String bussinesskeyFieldName,
