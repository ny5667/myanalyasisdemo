...
@Service("sESECDEmEventLeveLImportService")
public class SESECDEmEventLeveLImportServiceImpl implements SESECDEmEventLeveLImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_emEventInfo",model="SESECD_1.0.0_emEventInfo_EmEventLeveL",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEmEventLeveL bizObj, SESECDEmEventLeveL oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
		String dataLogOpType = null;
		if (null != oldBizObj) {
			AuditUtil.setAuditOperationType("2");
			AuditUtil.setAuditDes("修改" + InternationalResource.get("SESECD.entityname.randon1691460842170") + "信息");
			...
			AuditUtil.setAuditDes("新增" + InternationalResource.get("SESECD.entityname.randon1691460842170") + "信息");
			if(!StringUtils.isEmpty(AuditUtil.getColumnStringA())){
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEmEventLeveL bizObj, String bussinesskeyFieldName,
