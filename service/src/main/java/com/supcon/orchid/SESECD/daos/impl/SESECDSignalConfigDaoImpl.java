...
/* CUSTOM CODE START(daoimpl,import,SESECD_1.0.0_signalConfig_SignalConfig,SESECD_1.0.0) */
// 自定义代码

/* CUSTOM CODE END */

@Repository
public class SESECDSignalConfigDaoImpl extends ExtendedGenericDaoImpl<SESECDSignalConfig, Long> implements SESECDSignalConfigDao {
	@Override
	...
	@Override
	public SESECDSignalConfigDealInfo copyAndSaveDealInfo(DealInfo di) {
		SESECDSignalConfigDealInfo dealInfo = new SESECDSignalConfigDealInfo();
	...
	@Override
	public SESECDSignalConfigDealInfo copyAndSaveDealInfo(DealInfo di, SESECDSignalConfig mainObj, Staff dealStaff) {
		SESECDSignalConfigDealInfo dealInfo = copyAndSaveDealInfo(di);
	...
	public Date findLastDealInfo(Long tableInfoId, String activityName) {
		Criteria criteria = getSession().createCriteria(SESECDSignalConfigDealInfo.class);
		...
		List<SESECDSignalConfigDealInfo> dealinfo = criteria.list();
		return (dealinfo!=null&&!dealinfo.isEmpty()) ? dealinfo.get(0).getCreateTime() : null;
	}

	/* CUSTOM CODE START(daoimpl,functions,SESECD_1.0.0_signalConfig_SignalConfig,SESECD_1.0.0) */
// 自定义代码
