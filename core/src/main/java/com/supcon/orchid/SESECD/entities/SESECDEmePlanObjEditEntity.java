...
public class SESECDEmePlanObjEditEntity implements Serializable {
	...
	private SESECDEmePlanObj emePlanObj;

	public SESECDEmePlanObj getEmePlanObj(){
		return emePlanObj;
	}

	public void setEmePlanObj(SESECDEmePlanObj emePlanObj){
		this.emePlanObj = emePlanObj;
	}
}