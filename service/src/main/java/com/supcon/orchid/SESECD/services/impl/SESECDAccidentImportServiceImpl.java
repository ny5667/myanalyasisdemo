...
@Service("sESECDAccidentImportService")
public class SESECDAccidentImportServiceImpl implements SESECDAccidentImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_alarmRecord",model="SESECD_1.0.0_alarmRecord_Accident",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDAccident bizObj, SESECDAccident oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDAccident bizObj, String bussinesskeyFieldName,
