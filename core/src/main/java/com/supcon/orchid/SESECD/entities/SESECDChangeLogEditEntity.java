...
public class SESECDChangeLogEditEntity implements Serializable {
	...
	private SESECDChangeLog changeLog;

	public SESECDChangeLog getChangeLog(){
		return changeLog;
	}

	public void setChangeLog(SESECDChangeLog changeLog){
