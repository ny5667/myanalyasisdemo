...
@Service("sESECDEcdActionImportService")
public class SESECDEcdActionImportServiceImpl implements SESECDEcdActionImportService {
	...
	@Override
	@AuditLog(entity="SESECD_1.0.0_ecdPanel",model="SESECD_1.0.0_ecdPanel_EcdAction",desc="保存业务信息",operType="1")
	public void saveImportDataLog(SESECDEcdAction bizObj, SESECDEcdAction oldBizObj, String bussinesskeyFieldName, String mainDispalyFieldName) {
	...
	private void setBussinessKeyAndMainDispalyField(SESECDEcdAction bizObj, String bussinesskeyFieldName,
