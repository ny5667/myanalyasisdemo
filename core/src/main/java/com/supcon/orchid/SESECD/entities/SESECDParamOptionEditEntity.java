...
public class SESECDParamOptionEditEntity implements Serializable {
	...
	private SESECDParamOption paramOption;

	public SESECDParamOption getParamOption(){
		return paramOption;
	}

	public void setParamOption(SESECDParamOption paramOption){
